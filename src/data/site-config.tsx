import { SiteConfig, AppInfo, HowItWorks, Features, Downloads } from "./types";
...
export const downloads: Downloads = {
  ...
  android: {
    arm64: `https://github.com/Anomali99/FinTale/releases/download/${appInfo.version}/FinTale-${appInfo.version}-arm64-v8a.apk`,
    armeabi: `https://github.com/Anomali99/FinTale/releases/download/${appInfo.version}/FinTale-${appInfo.version}-armeabi-v7a.apk`,
    x86_64: `https://github.com/Anomali99/FinTale/releases/download/${appInfo.version}/FinTale-${appInfo.version}-x86_64.apk`,
    universal: `https://github.com/Anomali99/FinTale/releases/download/${appInfo.version}/FinTale-${appInfo.version}-universal.apk`,
  },
};
